...
if __name__ == '__main__':
    ...
    load_path = os.path.join(config.data.base_path, 'train')
    ...
    train_data = dataset.CATADatasetV2(os.path.join(load_path, 'train'))
    val_data = dataset.CATADatasetV2(os.path.join(load_path, 'val'))
    test_data = None
